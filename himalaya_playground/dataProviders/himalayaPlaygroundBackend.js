...
(function() {
    var provider = app.data.himalayaPlaygroundBackend = new Everlive({
            offlineStorage: true,
    ...
    document.addEventListener('online', function() {
        app.data.himalayaPlaygroundBackend.offline(false);
        app.data.himalayaPlaygroundBackend.sync();
    });

    document.addEventListener('offline', function() {
        app.data.himalayaPlaygroundBackend.offline(true);
    });

}());

// START_CUSTOM_CODE_himalayaPlaygroundBackend
// END_CUSTOM_CODE_himalayaPlaygroundBackend