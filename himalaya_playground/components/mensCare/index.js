...
(function(parent) {
    var dataProvider = app.data.himalayaPlaygroundBackend,
        ...
        mensCareModel = kendo.observable({
            dataSource: dataSource,
            itemClick: function(e) {
                app.mobileApp.navigate('#components/mensCare/details.html?uid=' + e.dataItem.uid);
            },
            detailsShow: function(e) {
                var item = e.view.params.uid,
                    dataSource = mensCareModel.get('dataSource'),
                ...
                mensCareModel.set('currentItem', itemModel);
            },
            currentItem: null
        });
