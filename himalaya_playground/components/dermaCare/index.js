...
(function(parent) {
    var dataProvider = app.data.himalayaPlaygroundBackend,
        ...
        dermaCareModel = kendo.observable({
            dataSource: dataSource,
            itemClick: function(e) {
                app.mobileApp.navigate('#components/dermaCare/details.html?uid=' + e.dataItem.uid);
            },
            detailsShow: function(e) {
                var item = e.view.params.uid,
                    dataSource = dermaCareModel.get('dataSource'),
                ...
                dermaCareModel.set('currentItem', itemModel);
            },
            currentItem: null
        });
...
// START_CUSTOM_CODE_dermaCareModel
// END_CUSTOM_CODE_dermaCareModel