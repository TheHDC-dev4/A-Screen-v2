...
// START_CUSTOM_CODE_animalCare
// END_CUSTOM_CODE_animalCare
(function(parent) {
    var dataProvider = app.data.himalayaPlaygroundBackend,
        ...
        animalCareModel = kendo.observable({
            dataSource: dataSource,
            itemClick: function(e) {
                app.mobileApp.navigate('#components/animalCare/details.html?uid=' + e.dataItem.uid);
            },
            detailsShow: function(e) {
                var item = e.view.params.uid,
                    dataSource = animalCareModel.get('dataSource'),
                ...
                animalCareModel.set('currentItem', itemModel);
            },
            currentItem: null
        });

    parent.set('animalCareModel', animalCareModel);
})(app.animalCare);
...
// END_CUSTOM_CODE_animalCareModel