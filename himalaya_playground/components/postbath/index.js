...
(function(parent) {
    var dataProvider = app.data.himalayaPlaygroundBackend,
        ...
        postbathModel = kendo.observable({
            dataSource: dataSource,
            itemClick: function(e) {
                app.mobileApp.navigate('#components/postbath/details.html?uid=' + e.dataItem.uid);
            },
            detailsShow: function(e) {
                var item = e.view.params.uid,
                    dataSource = postbathModel.get('dataSource'),
                ...
                postbathModel.set('currentItem', itemModel);
            },
            currentItem: null
        });
