...
(function(parent) {
    var dataProvider = app.data.himalayaPlaygroundBackend,
        ...
        oralCareModel = kendo.observable({
            dataSource: dataSource,
            itemClick: function(e) {
                app.mobileApp.navigate('#components/oralCare/details.html?uid=' + e.dataItem.uid);
            },
            detailsShow: function(e) {
                var item = e.view.params.uid,
                    dataSource = oralCareModel.get('dataSource'),
                ...
                oralCareModel.set('currentItem', itemModel);
            },
            currentItem: null
        });
